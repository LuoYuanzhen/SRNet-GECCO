...
class BadClassifierMAPLE(MAPLE):
    # this is for the MAPLE model when the mr_train only has one class to predict, then the MAPLE is failed
    def __init__(self, estimator, linear_model, label):
        super(BadClassifierMAPLE, self).__init__(estimator, linear_model)
